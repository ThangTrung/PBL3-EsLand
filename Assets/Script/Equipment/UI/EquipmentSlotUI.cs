...
namespace Script.Equipment.UI
{
        ...
        IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void SetEquipmentManager(IEquipmentManager manager) => _equipmentManager = manager;
        ...
        {
            if (highlightImage) highlightImage.gameObject.SetActive(isHighlighted);
        }
